...
public class UserService {
	...
	public ResponseEntity<EventUser> findUserById(@PathVariable String id) throws UserNotFoundException{  
	...
	public ResponseEntity<EventUser> addUser(EventUser eventUser){ 
		return ResponseEntity.ok(userRepository.save(eventUser));
	}
}
